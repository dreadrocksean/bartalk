...
export default StyleSheet.create({
  ...
  videoPlayBadge: {
    width: unity * 52,
    height: unity * 52,
    borderRadius: unity * 26,
    backgroundColor: "rgba(0, 0, 0, 0.45)",
    borderWidth: unity * 1.5,
  ...
  mediaStackLayerImage: {
    width: "100%",
    height: "100%",
  },
  mediaStackCountBadge: {
    position: "absolute",
    top: unity * 8,
    right: unity * 8,
    minWidth: unity * 26,
    height: unity * 26,
    borderRadius: unity * 13,
  ...
  pendingMediaVideoOverlay: {
    position: "absolute",
    left: 0,
    right: 0,
    bottom: 0,
    paddingHorizontal: unity * 5,
    paddingVertical: unity * 3,
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
    borderBottomLeftRadius: unity * 10,
    borderBottomRightRadius: unity * 10,
    backgroundColor: "rgba(0, 0, 0, 0.5)",
  },
  pendingMediaVideoGlyph: {
    color: "#fff",
    fontSize: unity * 10,
  },
  pendingMediaVideoDuration: {
    color: "#fff",
    fontSize: unity * 10,
    fontWeight: "600",
    fontVariant: ["tabular-nums"],
